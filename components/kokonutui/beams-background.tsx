...
export default function BeamsBackground({
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex h-screen w-full items-center justify-center mt-[6.5rem]">
                <div className="flex flex-col items-center justify-center gap-6 px-4 text-center">
                    {/* <motion.h1
                        className="text-4xl md:text-5xl lg:text-6xl font-semibold text-neutral-900 dark:text-white tracking-tighter"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.8 }}
                    >
                      Get the most out of url from Gemini
                    </motion.h1> */}
                    {children}
                </div>
            </div>
